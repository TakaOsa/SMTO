function [ x, J ] = DrawFourLink( basePos, L, q , figHandle, grayScale)
...
%     J(2,3) =  L(3) * cos(q(1) + q(2) + q(3)); 
    ...
    figure(figHandle);
    x_pos = [ basePos; x  ];
    line(x_pos(:,1), x_pos(:,2), 'Color',grayScale*[0.8 0.8 0.8]);
    hold on;
    plot(basePos(1, 1), basePos(1, 2), 'o', 'Color',grayScale*[0.8 0.8 0.8]);
    plot(x(1, 1), x(1, 2), 'o', 'Color',grayScale*[0.8 0.8 0.8]);
    plot(x(2, 1), x(2, 2), 'o', 'Color',grayScale*[0.8 0.8 0.8]);
    plot(x(3, 1), x(3, 2), 'o', 'Color',grayScale*[0.8 0.8 0.8]);
    plot(x(4, 1), x(4, 2), 'o', 'Color',grayScale*[0.8 0.8 0.8]);
